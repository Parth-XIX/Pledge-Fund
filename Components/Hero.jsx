      ...
      <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl
        ...
        <div className="flex flex-col items-center justify-between xl:flex-row"»
          <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
            <h2 className="max-w-1g mb-6 font-sans text-3xl font-bold tracking-tight
            ...
            <a
              href="/"
              aria-label=""
              AclassName="inline-flex items-center font-semibold tracking-wider
          ...
          <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
            ...
            <form>
              ...
              <div className="mt-4 mb-2 sm:mb-4">
                ...
                focus: outline-none newColor">Create Campaign</button>
              </div>
