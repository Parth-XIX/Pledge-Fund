...
return (
  ...
  md: px-24 1g: px-8 lg: py-20">
  <p className="py-16 text-2xl font-bold leading-5"> {title}</p>
  <div className="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto 1g:max-w-full">
    {allcampaign?.map ( (campaign, i) => (
      <div
        ...
        hover: text-deep-purple-accent-700">
          <p className="text-2xl font-bold leading-5">{campaian.title}</p>
        </a>
